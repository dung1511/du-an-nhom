...
urlpatterns = [
    ...
    path('api/reservations/<int:id>/upload-deposit-receipt/', views.UploadDepositReceiptAPIView.as_view(), name='api_upload_deposit_receipt'),
    path('api/reservations/checkin/', views.ReservationCheckInAPIView.as_view(), name='api_checkin'),
    ...
    path('api/payments/momo/webhook/', views.MoMoPaymentWebhookAPIView.as_view(), name='api_momo_payment_webhook'),
    path('api/payments/vietqr/webhook/', views.MoMoPaymentWebhookAPIView.as_view(), name='api_vietqr_payment_webhook'),
    path('api/payments/status/<str:booking_code>/', views.BankTransferPaymentStatusAPIView.as_view(), name='api_payment_status_by_booking_code'),
    ...
    path('api/admin/reservations/<int:id>/confirm-deposit/', views.AdminConfirmDepositAPIView.as_view(), name='api_admin_confirm_deposit'),
    ...
    path('frontdesk/print/<str:booking_code>/', views.frontdesk_print_slip, name='frontdesk_print_slip'),
    ...
    path('reservations/<int:reservation_id>/upload-deposit/', views.upload_deposit_page, name='upload_deposit_page'),
]   