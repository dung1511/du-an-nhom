...
def test_reservation_payment_method_choices():
    """Test new cash and MoMo QR payment methods."""
    ...
    assert cash_reservation.get_payment_method_display() == "Cash"
    assert momo_reservation.payment_method == "momo_qr"
    assert momo_reservation.get_payment_method_display() == "MoMo QR"
